<?php get_header(); ?>
            <section class="l-front">
                ...
                <article class="c-flex--fd-column-to-row">
                    <div class="c-image--front-left-center c-bgp--center-cover-no-repeat c-flex--ai-flex-end c-text--40-to-tb45-to-pc50 c-text--Roboto c-color--white">
                        <h3>Take Out</h3>
                    ...
                    <div class="c-image--front-right-center c-bgp--center-cover-no-repeat c-flex--ai-flex-end c-text--40-to-tb45-to-pc50 c-text--Roboto c-color--white">
                        <h3>Eat In</h3>
                        <div class="c-container--front-inner">
                            <div class="c-container--front-items c-bg-color--tp80-white">
                ...
                <div class="c-image--map c-bg-color--tp60-black c-bgp--center-cover-no-repeat">
